...
<section class="content">
      ...
      @endif
      <form action="{{ route('blog.update',$post->id) }}" method="POST" data-parsley-validate="" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    data-parsley-required-message="Please Enter Title" value="{{$post->title}}">
                </div>
